    ...
    def probe(self, ips, ports):
        ...
        for ip in ips:
            for port in ports:
                ...
                # TODO: determin what last_status_code should return
                # if last_status_code != 403 and last_status_code != 404 and last_status_code != 204:
                #     return True # qc add, if probe_success for one ip, return. update, one ip 403, another is ok
